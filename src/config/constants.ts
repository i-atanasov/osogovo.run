...
export const products: ProductBoxProps[] = [
    {
        ...
        price: 30,
        latePrice: 40,
        priceLabel: '<b>Такса:</b> 30 лв (до 22 септември)',
        latePriceLabel: '<b>Такса:</b> 40 лв (след 22 септември)',
    },
    {
        distance: 26,
...
export const CourseDescription = {
    title: 'Трасе',
    description: 'Старт на площад Велбъжд в центъра на Кюстендил (530м Н.В.), преминава покрай стадиона, картинг пистата и Почивало, по горски път под х. Иглика до Студен кладенец, продължава по черен път и горска пътека през Бегбунар по централното било на Осогово до връх Руен (2251м Н.В.), връщане през Бегбунар по горски път до финала на Ски център Осогово (1625м Н.В.) За средна и къса дистанции пресечки на Превала и над х.Осогово.',
}
