const home = {
    ...
    records: {
        title: 'Рекорди на трасето',
        holder: 'Рекордьор',
        time: 'Време',
        bonus: 'Текущ бонус за подобрение на рекорда до връх Руен:',
        note: 'Ако бонусът не бъде присъден тази година, сумата се натрупва към бонуса за следващото издание.',
        male: {
            title: 'Мъже',
        },
        female: {
